...
class ToastService {
  ...
  static void show(String message, {int durationMs = 3000}) {
    ...
    _toastEntry = OverlayEntry(
      builder: (context) => _TopToastWidget(message: message, durationMs: durationMs)
    );
...
class _TopToastWidget extends StatefulWidget {
  ...
  const _TopToastWidget({Key? key, required this.message, required this.durationMs}) : super(key: key);
